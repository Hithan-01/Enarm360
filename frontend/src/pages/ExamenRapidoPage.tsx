...
const ExamenRapidoPage: React.FC = () => {
  ...
  const especialidadesCompletas = [
    ...
    // Inglés
    { id: 29, nombre: "Inglés", categoria: "idiomas" },
    ...
    >
      ...
      <Group justify="space-between" align="flex-start" mb="md">
        <Box>
          ...
          >
            Configura tu examen rápido seleccionando especialidades y número de preguntas
          </Text>
        </Box>
                        ...
                        <Badge
                          ...
                          style={{
                            backgroundColor: selectedCount > 0
                              ...
                              : 'transparent',
                            borderColor: colorScheme === 'dark' ? '#0ea5e9' : '#8b7355',
                              ...
                              styles={{
                                ...
                                root: {
                                  ...
                                  borderColor: isSelected
                                    ? colorScheme === 'dark' ? '#0ea5e9' : '#8b7355'
                                    : colorScheme === 'dark' ? 'rgba(255, 255, 255, 0.2)' : 'rgba(221, 216, 209, 0.5)',
                                  '&:hover': {
                                    backgroundColor: isSelected
                                      ? colorScheme === 'dark' ? '#0284c7' : '#7a6749'
                                      : colorScheme === 'dark'
                                        ? 'rgba(255, 255, 255, 0.05)'
                                        : 'rgba(160, 142, 115, 0.1)',
                                  },
